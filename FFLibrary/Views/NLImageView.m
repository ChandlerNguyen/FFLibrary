...
#import "NLImageView.h"
#import "UIImage+Cropper.h"
#import "objc/runtime.h"
#import "UIView+WebCacheOperation.h"
#import "UIImageView+WebCache.h"

@interface NLImageView() <SDWebImageManagerDelegate>

@property (nonatomic, strong) SDWebImageManager *webManager;

@end

@implementation NLImageView
...
- (UIImage *)transformImage:(UIImage *)image {
    ...
    if (self.imageViewType == NLImageViewTypeSquare) {
        return [image imageByScaleAndCrop:self.frame.size];
    }
    else if (self.imageViewType == NLImageViewTypeCircle) {
